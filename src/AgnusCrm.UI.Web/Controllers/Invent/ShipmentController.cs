...
namespace AgnusCrm.Controllers.Invent
{
    ...
    public class ShipmentController : Controller
    {
        ...
        public ShipmentController(ApplicationDbContext context, IAgnusCrmService AgnusCrmService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("shipmentId,salesOrderId,shipmentNumber,shipmentDate,customerId,customerPO,invoice,branchId,warehouseId,expeditionType,expeditionMode,HasChild,createdAt")] Shipment shipment)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    VMStock stock = _AgnusCrmService.GetStockByProductAndWarehouse(item.productId, shipment.warehouseId);
                    if (stock != null)
                    {
